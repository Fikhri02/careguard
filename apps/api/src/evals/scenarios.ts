...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    checks: (last) => [
      ...
      check.checkNotMentions(last.reply, /(salah awak|kenapa awak|sepatutnya awak|your fault|should have)/i, "doesn't blame them"),
    ],
  ...
  },
  {
    ...
    checks: (last) => [
      ...
      check.checkMentions(last.reply, /nombor lama/i, "says to call the child's old number first"),
    ],
